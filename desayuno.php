...
<body>
	...
	<section id="topic-header">
		<div class="container">
			<div class="row">
				<div class="col-md-4" class="class-submenu">
					<h1>DESAYUNO</h1>
					<p>Comer delicioso y saludable.</p>
				</div>	<!-- End of /.col-md-4 -->	
				<div class="col-md-8 hidden-xs">
					<ol class="breadcrumb pull-right">
					  	<li><a href="index.php">Inicio</a></li>
					  	<li class="active">Categorías / Desayuno</li>
					</ol>
				</div>	<!-- End of /.col-md-8 -->
			</div>	<!-- End of /.row -->
					    ...
					    <li>
					        ...
					        <div class="blog-box">
					            ...
					            <div class="blog-post-body clearfix">
						            ...
						            <p>Toda felicidad depende de un buen desayuno</p>
